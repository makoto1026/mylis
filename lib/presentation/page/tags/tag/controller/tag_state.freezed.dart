...
abstract class $TagStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Tag> tagList, String? uuid, Tag tag, int count});
}
...
class _$_TagState extends _TagState {
  ...
  @override
  String toString() {
    return 'TagState(tagList: $tagList, uuid: $uuid, tag: $tag, count: $count)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_tagList), uuid, tag, count);
...
abstract class _TagState extends TagState {
  const factory _TagState(
      ...
      required final int count}) = _$_TagState;
